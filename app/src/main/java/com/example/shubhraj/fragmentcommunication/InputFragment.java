...
public class InputFragment extends Fragment
{
    ...
    public static InputFragment newInstance(String param1) {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        textView = (TextView) view.findViewById(R.id.textInput);
        textView.setText(mParam1);
        editText = (EditText) view.findViewById(R.id.editInput);
        button = (Button) view.findViewById(R.id.buttonInput);
